  ...
  return (
    <View
      ...
      <View
        ...
        <Text style={[{color: variables.white}]}>Hoje</Text>
      </View>
      <View style={[styles.row, styles.my10, {flex: 1}]}>
        <Icon
          name="heart"
        ...
        <View style={[styles.colorWhite, styles.row, styles.ml10, {flex: 2}]}>
          <Text
            ...
            89
            <Text
              style={[{fontSize: 20, color: variables.white}, styles.textLeft]}>
              &nbsp; bpm
            </Text>
          </Text>
        </View>
        ...
        <View
          ...
          <Text style={[{color: variables.white, textAlign: 'right'}]}>
            agora
          </Text>
        </View>
      </View>
